...
var conv = new _Converter2.default(rootElement, 1.11745);
conv.render();
...
var _class = function () {
  function _class(rootElement, eur_usd_coeff) {
  ...
  _createClass(_class, [{
    ...
    value: function render() {
      ...
      (0, _jquery2.default)('button').off('click');
      ...
      (0, _jquery2.default)('#convertEURtoUSD').on('click', function () {
        _this.convertEURtoUSD();
      });
      (0, _jquery2.default)('#convertUSDtoEUR').on('click', function () {
        _this.convertUSDtoEUR();
      });
    }
  }, {
    key: 'convertEURtoUSD',
    value: function convertEURtoUSD() {
      this.EUR = (0, _jquery2.default)('#EUR').val();
      this.USD = this.EUR * this.eur_usd_coeff;
      this.render();
    }
  }, {
    key: 'convertUSDtoEUR',
    value: function convertUSDtoEUR() {
      this.USD = (0, _jquery2.default)('#USD').val();
